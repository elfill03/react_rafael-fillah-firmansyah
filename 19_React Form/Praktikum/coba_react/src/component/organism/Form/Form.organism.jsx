        ...
        <div className="d-grid">
          ...
          >
            ...
            >
              ...
              />
              {formik.errors.productname && <div className="error-msg">{formik.errors.productname}</div>}

              <ProductCategory
                onChange={formik.handleChange}
                value={formik.values.productcategory}
              />
              {formik.errors.productcategory && <div className="error-msg">{formik.errors.productcategory}</div>}

              <ProductImage
                onChange={formik.handleChange}
                value={formik.values.productimage}
              />
              {formik.errors.productimage && <div className="error-msg">{formik.errors.productimage}</div>}
              ...
              />
              {formik.errors.productfreshness && <div className="error-msg">{formik.errors.productfreshness}</div>}

              <ProductDescription
                onChange={formik.handleChange}
                value={formik.values.productdescription}
              />
              {formik.errors.productdescription && <div className="error-msg">{formik.errors.productdescription}</div>}

              <ProductPrice
                onChange={formik.handleChange}
                value={formik.values.productprice}
              />
              {formik.errors.productprice && <div className="error-msg">{formik.errors.productprice}</div>}
